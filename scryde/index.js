var weaponBlessScrollPrice = 640_000_000;
var weaponRegularScrollPrice = 18_000_000;
var armorBlessScrollPrice = 155_000_000;
var armorRegularScrollPrice = 2_000_000;
var weaponChance = [100, 100, 100, 66, 64, 61, 57, 54, 51, 48, 45, 45, 45, 42, 42, 39]
var armorChance = [100, 100, 100, 60, 58, 56, 50, 48, 46, 44, 40, 36, 0, 0, 0, 0]
...
var enchant = (useBlessScrolls = false) => {
  ...
  while (true) {
    ...
    let chance = isWeapon ? (weaponChance[results.currentEnchant]/100) : (armorChance[results.currentEnchant]/100);
